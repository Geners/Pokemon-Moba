// MemorizingMagic.cpp : Defines the entry point for the console application.
//
...
void walkUpperRightAnimation()
{
        ...
        window.draw(Charmander);
        window.display();
        Charmander.move(+10.1,-10.1);
        window.clear();
        texture.loadFromFile("PokeSprites.png", IntRect(32,0,32,32));
        Charmander.setTexture(texture);
        window.draw(Charmander);
        Charmander.move(+5.1,-5.1);
        window.display();
